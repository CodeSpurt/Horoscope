...
public class HoroscopeWeek extends Fragment {
    ...
    HttpGetData httpGetData = new HttpGetData() {
        ...
        public void getData(String data) {
            ...
            if (parsedData != null) {
                HoroscopeWeek.this.title.setText("This Week's Horoscope");
                HoroscopeWeek.this.data.setText(utility.filterData(parsedData.getHoroscope()));
            } else {
                HoroscopeWeek.this.data.setText(getResources().getString(R.string.no_internet_connection));
            }
        }
    };
    ...
    private void getHoroscope() {
        ...
        request.execute(new Urls().getBaseUrl() + "/week/" + sign);
    }
}