...
public class HoroscopeMonth extends Fragment {
    ...
    HttpGetData httpGetData = new HttpGetData() {
        ...
        public void getData(String data) {
            ...
            if (parsedData != null) {
                HoroscopeMonth.this.title.setText("This Month's Horoscope");
                HoroscopeMonth.this.data.setText(utility.filterData(parsedData.getHoroscope()));
            } else {
                HoroscopeMonth.this.data.setText(getResources().getString(R.string.no_internet_connection));
            }
        }
    };
    ...
    private void getHoroscope() {
        ...
        request.execute(new Urls().getBaseUrl() + "/month/" + sign);
    }
}