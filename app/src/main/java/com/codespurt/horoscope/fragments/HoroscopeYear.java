...
public class HoroscopeYear extends Fragment {
    ...
    HttpGetData httpGetData = new HttpGetData() {
        ...
        public void getData(String data) {
            ...
            if (parsedData != null) {
                HoroscopeYear.this.title.setText("This Year's Horoscope");
                HoroscopeYear.this.data.setText(utility.filterData(parsedData.getHoroscope()));
            } else {
                HoroscopeYear.this.data.setText(getResources().getString(R.string.no_internet_connection));
            }
        }
    };
    ...
    private void getHoroscope() {
        ...
        request.execute(new Urls().getBaseUrl() + "/year/" + sign);
    }
}